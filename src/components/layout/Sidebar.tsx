                ...
                <div className="flex h-full flex-col px-4 py-8">
                    <div className="mb-10 px-2 flex items-center justify-between">
                        <Link href="/" className="flex items-center gap-3 group">
                            <div className="h-8 w-8 rounded-lg bg-primary flex items-center justify-center font-black text-white italic shadow-[0_0_15px_rgba(107,92,230,0.4)] transition-transform group-hover:scale-105">
                                C
                            </div>
